...
3. **ba-pipeline will auto-detect project type and load project knowledge from:**
   - `.agent/projects/Capstone/` - if Capstone ERP detected (SAL/CS/WH/HR/SYS/MTB module codes)
...
| `.agent\projects\Capstone\standards\*.md` | embedded in guides (standards enforced) |
| `.agent\projects\Capstone\memory\*.md` | additional context (if HM project) |
...
Analysis complete:
   ...
   Memory:       .agent\projects\Capstone\memory\{Feature}.md      [if HM project]
